...
# data_location = '/home/shinbs/datas'
...
class Image3DDatasetCondMaskGrad(Dataset):
    def __init__(self,
                 root,
                 root_mask,
                 root_grad,
    ...
    def __getitem__(self, idx):
        ...
        return img_datas, img_datas_mask, img_datas_grad, slice_nums, idx
...
def get_loaders(rank, imgstr, resolution, timesteps, skip, batch_size=1, n_gpus=1, seed=42,  cond=False):
    ...
    if imgstr == 'CHAOS':
        ...
        train_dir_grad = os.path.join(data_location, 'HCP_1200_norm_res_128_s_16_pd_2_grad_msk')
    elif imgstr == 'HCP_CROP':
        train_dir = os.path.join(data_location, 'HCP_1200_norm_res_128_crop_s_16')
        train_dir_mask = os.path.join(data_location, 'HCP_1200_norm_res_128_s_16_pd_2_mask')
        train_dir_grad = os.path.join(data_location, 'HCP_1200_norm_res_128_crop_grad_12_sqrt_s_16')
    elif imgstr == 'SYNTHRAD_BRAIN_CT':
        train_dir = os.path.join(data_location, 'SYNTHRAD2023_brain_res_128_s_16_pd_2/ct')
        train_dir_mask = os.path.join(data_location, 'SYNTHRAD2023_brain_res_128_s_16_pd_2/mask')
        train_dir_grad = os.path.join(data_location, 'SYNTHRAD2023_brain_res_128_s_16_pd_2/ct_grad')
    elif imgstr == 'SYNTHRAD_BRAIN_MR':
        train_dir = os.path.join(data_location, 'SYNTHRAD2023_brain_res_128_s_16_pd_2/mr')
        train_dir_mask = os.path.join(data_location, 'SYNTHRAD2023_brain_res_128_s_16_pd_2/mask')
        train_dir_grad = os.path.join(data_location, 'SYNTHRAD2023_brain_res_128_s_16_pd_2/mr_grad')
    elif imgstr == 'HCP_CROP_PD_2':
        train_dir = os.path.join(data_location, 'HCP_1200_norm_res_128_crop_s_16_pd_2')
        train_dir_mask = os.path.join(data_location, 'HCP_1200_norm_res_128_s_16_pd_2_mask')
        train_dir_grad = os.path.join(data_location, 'HCP_1200_norm_res_128_s_16_pd_2_grad')
    elif imgstr == 'HCP_CROP_PD_2_SINGLE':
        train_dir = os.path.join(data_location, 'HCP_1200_norm_res_128_crop_s_16_pd_2_single')
    elif imgstr == 'HCP_CROP_XZ_SWP_PD_2_SINGLE':
        train_dir = os.path.join(data_location, 'HCP_1200_norm_res_128_crop_swp_xz_s_16_pd_2_single')
    ...
    trainset = Image3DDatasetCondMaskGrad(train_dir, train_dir_mask, train_dir_grad, train=True, resolution=resolution)
    print(len(trainset))
    testset = Image3DDatasetCondMaskGrad(train_dir, train_dir_mask, train_dir_grad, train=False, resolution=resolution)
    print(len(testset))
