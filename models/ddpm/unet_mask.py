...
class DiffusionWrapper(nn.Module):
    ...
    def forward(self, x, cond, t, c_x, c_m, c_concat: list = None, c_crossattn: list = None):
...
class UNetModel(nn.Module):
    ...
    def forward(self, x, cond=None, timesteps=None, c_x=None, c_m=None, context=None, y=None, lc=0):
        """
